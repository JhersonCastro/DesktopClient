...
public class MisProyectosDocenteController extends UIBase implements ListController, Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        proyectos.add(new ProjectCardDTO(5L,"Sistema de Inventarios", "Juan Pérez", "Investigación", "Dr. Gómez"));
        proyectos.add(new ProjectCardDTO(4L,"App Móvil Educativa", "María Gómez", "Práctica Profesional", "Mg. Martínez"));
        proyectos.add(new ProjectCardDTO(3L,"Control de Asistencias", "Carlos Ramírez", "Investigación", "Dra. Fernández"));
        proyectos.add(new ProjectCardDTO(2L,"Página Web de la Empresa", "Ana Torres", "Práctica Profesional", "Dr. Hernández"));
